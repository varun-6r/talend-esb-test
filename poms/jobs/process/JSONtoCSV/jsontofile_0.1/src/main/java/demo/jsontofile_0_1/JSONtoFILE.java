...
/**
 * Job: JSONtoFILE Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status DEV
 */
public class JSONtoFILE implements TalendJob {
	...
	private final String jobName = "JSONtoFILE";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(JSONtoFILE.this, new Object[] { e,
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final JSONtoFILE job;

		public RestServiceProviderImpl4TalendJob(JSONtoFILE job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(
				java.util.Map<String, Object> requestGlobalMap, JSONtoFILE job) {
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(JSONtoFILE job,
				String endpointUrl) {
			this.job = job;
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_DEMO_JSONtoFILE = new byte[0];
		static byte[] commonByteArray_DEMO_JSONtoFILE = new byte[0];
		...
		public String expectedShippingDate;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEMO_JSONtoFILE.length) {
					if (length < 1024
							&& commonByteArray_DEMO_JSONtoFILE.length == 0) {
						commonByteArray_DEMO_JSONtoFILE = new byte[1024];
					} else {
						commonByteArray_DEMO_JSONtoFILE = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEMO_JSONtoFILE, 0, length);
				strReturn = new String(commonByteArray_DEMO_JSONtoFILE, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_JSONtoFILE) {

				try {

					int length = 0;

					this.groupType = readString(dis);

					this.groupID = readString(dis);

					this.pickID = readString(dis);

					this.containerID = readString(dis);

					this.containerType = readString(dis);

					this.sourceLocation = readString(dis);

					this.destinationLocation = readString(dis);

					this.unitOfMeasureQuantity = readString(dis);

					this.unitOfMeasure = readString(dis);

					this.eachQuantity = readString(dis);

					this.productID = readString(dis);

					this.lotID = readString(dis);

					this.identifiers = readString(dis);
					...
					this.length = readString(dis);

					this.width = readString(dis);

					this.height = readString(dis);

					this.weight = readString(dis);

					this.dimensionUnitOfMeasure = readString(dis);

					this.weightUnitOfMeasure = readString(dis);

					this.expectedShippingDate = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.groupType, dos);
				...
				writeString(this.pickID, dos);

				// String

				writeString(this.containerID, dos);

				// String

				writeString(this.containerType, dos);

				// String

				writeString(this.sourceLocation, dos);

				// String

				writeString(this.destinationLocation, dos);

				// String

				writeString(this.unitOfMeasureQuantity, dos);
				...
				writeString(this.eachQuantity, dos);
				...
				writeString(this.lotID, dos);

				// String

				writeString(this.identifiers, dos);
				...
				writeString(this.length, dos);

				// String

				writeString(this.width, dos);
				...
				writeString(this.dimensionUnitOfMeasure, dos);

				// String

				writeString(this.weightUnitOfMeasure, dos);

				// String

				writeString(this.expectedShippingDate, dos);
		...
		public String toString() {
			...
			sb.append(",pickID=" + pickID);
			sb.append(",containerID=" + containerID);
			sb.append(",containerType=" + containerType);
			sb.append(",sourceLocation=" + sourceLocation);
			sb.append(",destinationLocation=" + destinationLocation);
			sb.append(",unitOfMeasureQuantity=" + unitOfMeasureQuantity);
			sb.append(",unitOfMeasure=" + unitOfMeasure);
			sb.append(",eachQuantity=" + eachQuantity);
			sb.append(",productID=" + productID);
			sb.append(",lotID=" + lotID);
			...
			sb.append(",dimensionUnitOfMeasure=" + dimensionUnitOfMeasure);
			sb.append(",weightUnitOfMeasure=" + weightUnitOfMeasure);
			sb.append(",expectedShippingDate=" + expectedShippingDate);
			sb.append(",data=" + data);
			sb.append("]");
	...
	public static class log1Struct implements
			routines.system.IPersistableRow<log1Struct> {
		final static byte[] commonByteArrayLock_DEMO_JSONtoFILE = new byte[0];
		static byte[] commonByteArray_DEMO_JSONtoFILE = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(log1Struct other) {
	...
	public void tRESTRequest_1_LoopProcess(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				log1Struct log1 = new log1Struct();
				...
				if (execStat) {
					...
					runStat.updateStatOnConnection("log1" + iterateId, 0, 0);
				...
				try {
					...
					if (execStat) {
						if (resourceMap.get("inIterateVComp") == null) {
							...
							runStat.updateStatOnConnection("log1" + iterateId,
									0, 0);
					...
					log1Struct log1_tmp = new log1Struct();
							...
							for (int i_tExtractJSONFields_1 = 0; isStructError_tExtractJSONFields_1
								...
								if (row1 != null) {
									...
									{ // start of Var scope
										...
										// # Output table : 'log1'
										log1_tmp.messageType = row1.messageType;
										log1 = log1_tmp;
									...
									if (log1 != null) {
										...
										if (log1.messageType != null) { //

											strBuffer_tLogRow_1.append(String
													.valueOf(log1.messageType));
										...
										if (extract2.picks != null) {// C_01
											...
											for (int i_tExtractJSONFields_2 = 0; isStructError_tExtractJSONFields_2
												...
												if (!isStructError_tExtractJSONFields_2) {
													...
													try {
														jsonPath_tExtractJSONFields_2 = "$.groupType";
														...
														try {
															...
															row2.groupType = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.groupID";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.groupID = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.pickID";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.pickID = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.container.containerID";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.containerID = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.container.containerType";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.containerType = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.sourceLocation";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.sourceLocation = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.destinationLocation";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.destinationLocation = value_tExtractJSONFields_2 == null ?
															...
															row2.destinationLocation =

															null

															;
														}
														jsonPath_tExtractJSONFields_2 = "$.product.unitOfMeasureQuantity";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.unitOfMeasureQuantity = value_tExtractJSONFields_2 == null ?
															...
															row2.unitOfMeasureQuantity =

															null

															;
														}
														jsonPath_tExtractJSONFields_2 = "$.product.unitOfMeasure";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.unitOfMeasure = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.eachQuantity";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.eachQuantity = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.product.productID";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.productID = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.product.lotID";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.lotID = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.identifiers";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.identifiers = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.product.name";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.name = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.product.description";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.description = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.product.image";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.image = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.product.length";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.length = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.product.width";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.width = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.product.height";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.height = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.product.weight";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.weight = value_tExtractJSONFields_2 == null ?
														...
														jsonPath_tExtractJSONFields_2 = "$.product.dimensionUnitOfMeasure";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.dimensionUnitOfMeasure = value_tExtractJSONFields_2 == null ?
															...
															row2.dimensionUnitOfMeasure =

															null

															;
														}
														jsonPath_tExtractJSONFields_2 = "$.product.weightUnitOfMeasure";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.weightUnitOfMeasure = value_tExtractJSONFields_2 == null ?
															...
															row2.weightUnitOfMeasure =

															null

															;
														}
														jsonPath_tExtractJSONFields_2 = "$.expectedShippingDate";
														compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
																.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.expectedShippingDate = value_tExtractJSONFields_2 == null ?
														...
														try {
															value_tExtractJSONFields_2 = compiledJsonPath_tExtractJSONFields_2
																	.read(row_tExtractJSONFields_2);
															row2.data = value_tExtractJSONFields_2 == null ?
												...
												if (row2 != null) {
													...
													if (row2.groupType != null) { //

														strBuffer_tLogRow_3
																.append(String
																		.valueOf(row2.groupType));
													...
													if (row2.groupID != null) { //

														strBuffer_tLogRow_3
																.append(String
																		.valueOf(row2.groupID));
													...
													if (row2.containerID != null) { //

														strBuffer_tLogRow_3
																.append(String
																		.valueOf(row2.containerID));
													...
													if (row2.containerType != null) { //

														strBuffer_tLogRow_3
																.append(String
																		.valueOf(row2.containerType));
													...
													if (row2.sourceLocation != null) { //

														strBuffer_tLogRow_3
																.append(String
																		.valueOf(row2.sourceLocation));
													...
													if (row2.destinationLocation != null) { //

														strBuffer_tLogRow_3
																.append(String
																		.valueOf(row2.destinationLocation));
													...
													if (row2.unitOfMeasureQuantity != null) { //

														strBuffer_tLogRow_3
																.append(String
																		.valueOf(row2.unitOfMeasureQuantity));
													...
													if (row2.unitOfMeasure != null) { //

														strBuffer_tLogRow_3
																.append(String
																		.valueOf(row2.unitOfMeasure));
													...
													if (row2.eachQuantity != null) { //

														strBuffer_tLogRow_3
																.append(String
																		.valueOf(row2.eachQuantity));
													...
													if (row2.identifiers != null) { //

														strBuffer_tLogRow_3
																.append(String
																		.valueOf(row2.identifiers));
													...
													if (row2.dimensionUnitOfMeasure != null) { //

														strBuffer_tLogRow_3
																.append(String
																		.valueOf(row2.dimensionUnitOfMeasure));
													...
													if (row2.weightUnitOfMeasure != null) { //

														strBuffer_tLogRow_3
																.append(String
																		.valueOf(row2.weightUnitOfMeasure));
													...
													if (row2.expectedShippingDate != null) { //

														strBuffer_tLogRow_3
																.append(String
																		.valueOf(row2.expectedShippingDate));
				...
				if (execStat) {
					...
					runStat.updateStatOnConnection("log1" + iterateId, 2, 0);
	...
	public static void main(String[] args) {
		final JSONtoFILE JSONtoFILEClass = new JSONtoFILE();

		int exitCode = JSONtoFILEClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = JSONtoFILE.class.getClassLoader()
					.getResourceAsStream(
							"demo/jsontofile_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = JSONtoFILE.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : JSONtoFILE");
		}
...
/************************************************************************************************
 * 109578 characters generated by Talend Open Studio for ESB on the 29 June,
 * 2018 12:23:34 AM IST
 ************************************************************************************************/
