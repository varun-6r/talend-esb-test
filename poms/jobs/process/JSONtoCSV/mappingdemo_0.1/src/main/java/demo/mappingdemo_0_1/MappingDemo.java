...
/**
 * Job: MappingDemo Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status DEV
 */
public class MappingDemo implements TalendJob {
	...
	private final String jobName = "MappingDemo";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MappingDemo.this, new Object[] { e,
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final MappingDemo job;

		public RestServiceProviderImpl4TalendJob(MappingDemo job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(
				java.util.Map<String, Object> requestGlobalMap, MappingDemo job) {
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(MappingDemo job,
				String endpointUrl) {
			this.job = job;
	...
	public static class tolog1Struct implements
			routines.system.IPersistableRow<tolog1Struct> {
		final static byte[] commonByteArrayLock_DEMO_MappingDemo = new byte[0];
		static byte[] commonByteArray_DEMO_MappingDemo = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEMO_MappingDemo.length) {
					if (length < 1024
							&& commonByteArray_DEMO_MappingDemo.length == 0) {
						commonByteArray_DEMO_MappingDemo = new byte[1024];
					} else {
						commonByteArray_DEMO_MappingDemo = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEMO_MappingDemo, 0, length);
				strReturn = new String(commonByteArray_DEMO_MappingDemo, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_MappingDemo) {

				try {

					int length = 0;

					this.arr = readString(dis);
		 ...
		 * Compare keys
		 */
		public int compareTo(tolog1Struct other) {
	...
	public void tRESTRequest_1_LoopProcess(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				tolog1Struct tolog1 = new tolog1Struct();
				...
				if (execStat) {
					...
					runStat.updateStatOnConnection("tolog1" + iterateId, 0, 0);
				...
				try {
					...
					tolog1Struct tolog1_tmp = new tolog1Struct();
					// ###############################
						...
						if (restout.body != null) {// C_01
							...
							for (int i_tExtractJSONFields_1 = 0; isStructError_tExtractJSONFields_1
								...
								if (!isStructError_tExtractJSONFields_1) {
									...
									try {
										...
										try {
											...
											row1.msg = value_tExtractJSONFields_1 == null ?
										...
										try {
											value_tExtractJSONFields_1 = compiledJsonPath_tExtractJSONFields_1
													.read(row_tExtractJSONFields_1);
											row1.arr = value_tExtractJSONFields_1 == null ?
								...
								if (row1 != null) {
									...
									System.out.println(row2.msg);
									System.out.println("Picks");
									System.out.println(row2.arr);
				...
				if (execStat) {
					...
					runStat.updateStatOnConnection("tolog1" + iterateId, 2, 0);
	...
	public static void main(String[] args) {
		final MappingDemo MappingDemoClass = new MappingDemo();

		int exitCode = MappingDemoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MappingDemo.class.getClassLoader()
					.getResourceAsStream(
							"demo/mappingdemo_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = MappingDemo.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : MappingDemo");
		}
...
/************************************************************************************************
 * 80074 characters generated by Talend Open Studio for ESB on the 29 June, 2018
 * 3:12:44 PM IST
 ************************************************************************************************/
