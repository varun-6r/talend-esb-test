...
/**
 * Job: JSONtoFILEv3 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status DEV
 */
public class JSONtoFILEv3 implements TalendJob {
	...
	private final String jobName = "JSONtoFILEv3";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(JSONtoFILEv3.this, new Object[] { e,
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final JSONtoFILEv3 job;

		public RestServiceProviderImpl4TalendJob(JSONtoFILEv3 job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(
				java.util.Map<String, Object> requestGlobalMap, JSONtoFILEv3 job) {
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(JSONtoFILEv3 job,
				String endpointUrl) {
			this.job = job;
	...
	public static class extract2Struct implements
		...
		final static byte[] commonByteArrayLock_DEMO_JSONtoFILEv3 = new byte[0];
		static byte[] commonByteArray_DEMO_JSONtoFILEv3 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEMO_JSONtoFILEv3.length) {
					if (length < 1024
							&& commonByteArray_DEMO_JSONtoFILEv3.length == 0) {
						commonByteArray_DEMO_JSONtoFILEv3 = new byte[1024];
					} else {
						commonByteArray_DEMO_JSONtoFILEv3 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEMO_JSONtoFILEv3, 0, length);
				strReturn = new String(commonByteArray_DEMO_JSONtoFILEv3, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_JSONtoFILEv3) {
	...
	public static class row3Struct implements
		...
		public String errorJSONField;

		public String getErrorJSONField() {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_JSONtoFILEv3) {
				...
				try {
					...
					this.errorJSONField = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.errorJSONField, dos);
		...
		public String toString() {
			...
			sb.append("messageType=" + messageType);
			sb.append(",picks=" + picks);
			sb.append(",errorJSONField=" + errorJSONField);
					...
					if (restout != null) {
						...
						if (restout.body != null) {// C_01
							...
							try {
								...
								row3 = new row3Struct();
								row3.errorJSONField = jsonStr_tExtractJSONFields_1;
								row3.errorMessage = ex_tExtractJSONFields_1
										.getMessage()
										+ " - Line: "
							...
							for (int i_tExtractJSONFields_1 = 0; isStructError_tExtractJSONFields_1
								...
								if (!isStructError_tExtractJSONFields_1) {
									...
									try {
										...
										row3 = new row3Struct();
										row3.messageType = row1.messageType;
										row3.picks = row1.picks;
										row3.errorJSONField = jsonStr_tExtractJSONFields_1;
										row3.errorMessage = ex_tExtractJSONFields_1
												.getMessage()
												+ " - Line: "
								...
								if (row3 != null) {
									...
									//
									// lowercase the name
									// row4.name = row3.name.toLowerCase();
	...
	public static void main(String[] args) {
		final JSONtoFILEv3 JSONtoFILEv3Class = new JSONtoFILEv3();

		int exitCode = JSONtoFILEv3Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = JSONtoFILEv3.class.getClassLoader()
					.getResourceAsStream(
							"demo/jsontofilev3_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = JSONtoFILEv3.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : JSONtoFILEv3");
		}
...
/************************************************************************************************
 * 81365 characters generated by Talend Open Studio for ESB on the 29 June, 2018
 * 2:58:24 PM IST
 ************************************************************************************************/
